...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */'use strict';exports.__esModule = true;function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{'default':obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass,superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _react=__webpack_require__(3);var _react2=_interopRequireDefault(_react);var _reactLibReactDOM=__webpack_require__(5);var _srcIndexJs=__webpack_require__(160);var _srcIndexJs2=_interopRequireDefault(_srcIndexJs); //联想功能组件
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsMultiDropDownMenuJs = __webpack_require__(161);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MultiDropDownMenu = (function (_Component) {
	                    ...
	                    { className: 'multi-drop-down-list-content',
	                        onMouseOver: function (e) {
	                            if (!_this.itemHeight) {
	                                ...
	                                _this.itemHeight = parentNode.offsetHeight;
	                            }
	                            _this.reCalPosFlag = true;
	                            _this.hoverEle = ele;
	                            _this.hoverEleIndex = index;
	                            _this.dropDownDepth = depth;
	    ...
	    MultiDropDownMenu.prototype.componentDidUpdate = function componentDidUpdate() {
	        var reCalPosFlag = this.reCalPosFlag;
	        var hoverEle = this.hoverEle;
	        var hoverEleIndex = this.hoverEleIndex;
	        var itemHeight = this.itemHeight;
	        var dropDownDepth = this.dropDownDepth;
	        var offsetYMap = this.offsetYMap;
	        var dropDownQueue = this.state.dropDownQueue;

	        //每次hover结束之后都需要重新计算位置
	        if (this.reCalPosFlag) {
	            //当前需要展开的那一列list
	            var curDropDownLi = this.refs['drop-down-' + (dropDownDepth + 1)],
	                curLevelData = this.props.dropDownData,
	                level1Length = curLevelData.length;
	            for (var index = 0; index < dropDownQueue.length; index++) {
	                curLevelData = curLevelData[dropDownQueue[index]].children;
	            }
	            //curLevelData为当前需要展开那一列list的data
	            if (curDropDownLi) {
	                var offsetY = hoverEleIndex * itemHeight;
	                //基于当前panel顶部的偏移量,offsetYMap始终缓存每一级panel基于第一级panel顶部的offset
	                offsetYMap[dropDownDepth] = offsetY;
	                if (dropDownDepth > 0) {
	                    //将其调整为基于第一级panel顶部的偏移量
	                    var parentOffsetY = offsetYMap[dropDownDepth - 1] || 0;
	    ...
	    MultiDropDownMenu.prototype.renderChildMenu = function renderChildMenu(listData, depth, dropDownQueue) {
	        ...
	        var XML = _react2['default'].createElement(
	            'ul',
	            { className: 'multi-drop-down-list select-drop-down-list', key: 'drop-down-' + depth, ref: 'drop-down-' + depth },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/_css-loader@0.17.0@css-loader/index.js!../../node_modules/_less-loader@2.2.3@less-loader/index.js!./public.less", function() {
				var newContent = require("!!../../node_modules/_css-loader@0.17.0@css-loader/index.js!../../node_modules/_less-loader@2.2.3@less-loader/index.js!./public.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
