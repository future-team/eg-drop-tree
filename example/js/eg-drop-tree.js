...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcIndexJs = __webpack_require__(160);
	...
	var IndexModule = (function (_Component) {
	    ...
	    function IndexModule(props, context) {
	    ...
	    IndexModule.prototype.render = function render() {
	        ...
	        var menuData = [{ data: '近一个周的问题', callback: function callback() {
	                alert('clicked');
	            } }, { data: '近一个月的问题', callback: function callback() {
	                alert('clicked');
	            } }, { data: '一个月之前的问题', callback: function callback() {
	                alert('clicked');
	            } }];
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_srcIndexJs2['default'], { dropDownData: mockMultiDropData, keyName: 'typeName', leafName: 'leaf', title: '树状列表选择', ref: 'MultiDropDownMenu' })
	            ),
	            _react2['default'].createElement(
	                'div',
	    ...
	    IndexModule.prototype.getDropDownData = function getDropDownData(type) {
	...
	_reactLibReactDOM.render(_react2['default'].createElement(IndexModule, null), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (window.Eagleui) {
	    Eagleui.MultiDropDownMenu = _componentsMultiDropDownMenuJs2['default'];
	} else {
	    window.MultiDropDownMenu = _componentsMultiDropDownMenuJs2['default'];
	};
	...
	var MultiDropDownMenu = (function (_Component) {
	    ...
	    MultiDropDownMenu.prototype.renderList = function renderList(type, ele, activeIndex, index, depth) {
	        ...
	        if (type == 'branch') {
	            ...
	            xml = _react2['default'].createElement(
	                'li',
	                { className: 'multi-drop-down-input', onClick: function () {
